...
public class CategoryAPIController {
	...
	public ResponseEntity<?> updateCategory(@Validated @RequestParam("categoryId") int categoryId, @Validated @RequestParam("categoryName") String categoryName, @Validated @RequestParam("icon") MultipartFile icon) {
